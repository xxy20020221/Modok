...
from .views import ChatMessageListView, search_group_messages, search_direct_messages, \
    UploadFileView, UploadImageView, GetChatGroupUsers, GetChatGroupByTeamID, GetUserAvatar
from . import views
...
urlpatterns = [
    ...
    path('chatroom/getavatar/<int:user_id>/',GetUserAvatar.as_view(), name="get_avatar")
]
